...
class SqliteRepository(Repository):
    ...
    def __init__(self,name,ring=False,max_register=-1):
        ...
        if res1.fetchone() is None:
            ...
            self.cur.execute("CREATE TABLE info_system(total_cpu,total_memory,available_memory,used_memory,memory_percent)")
        else:
    ...
    def log_start_process(self,proc):
        ...
        print('Se registra inicio del proceso {} con {}% y memoria {}%'.format(proc.name(),proc.cpu_percent(),proc.memory_percent()))        
 # AQUÌ GUARDARRR
