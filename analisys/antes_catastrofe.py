...
def plotMemory(df,process,node_name,pid):
    ...
    fmt = mdates.DateFormatter('%d-%H:%M:%S:%f')
...
consola='fm57-c01b'
intervalos_consola=[ ['2022-12-13 05:02:00' ,'2022-12-13 07:12:00'],
                     ['2022-12-13 13:59:00' ,'2022-12-13 16:35:00'],
                     ['2022-12-13 17:53:00' ,'2022-12-13 19:25:00'],
                     ['2022-12-14 19:53:00' ,'2022-12-14 21:55:00']
                     ]
for process in bus_comunication:
    print('.....................',process) 
    for date in intervalos_consola:   
        df1=query_general(sql_template,consola,process,'2022-12-13 05:02:00','2022-12-13 07:12:00')
