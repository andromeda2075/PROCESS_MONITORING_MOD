...
#https://python.hotexamples.com/examples/psutil/-/cpu_percent/python-cpu_percent-function-examples.html
#https://programacionpython80889555.wordpress.com/2020/09/08/monitorizando-uso-de-la-cpu-en-tiempo-real-con-tkinter-y-psutil/
#https://foroayuda.es/como-monitorear-el-uso-de-cpu-memoria-de-un-solo-proceso/
